...
:quickstart-project-name: quickstart-dotnetcore-fargate-cicd
:partner-product-name: .NET Core CI/CD pipeline with delivery to AWS Fargate
// For the following attribute, if you have no short name, enter the same name as partner-product-name.
:partner-product-short-name: .NET Core CI/CD pipeline with delivery to AWS Fargate
