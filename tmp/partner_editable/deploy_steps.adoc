...
. Sign in to your AWS account, and launch the following AWS CloudFormation template: https://fwd.aws/4VPBv?[Deploy {partner-product-short-name} into a new VPC on AWS^]. You can also https://fwd.aws/j37eE?[view the template^].
